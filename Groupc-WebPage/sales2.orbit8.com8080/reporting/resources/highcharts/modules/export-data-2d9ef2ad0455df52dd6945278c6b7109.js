...
*/
(function(c) {
    "object" === typeof module && module.exports ? (c["default"] = c, module.exports = c) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function(e) {
        c(e);
        c.Highcharts = e;
        return c
    ...
    c = c ? c._modules : {};
    e(c, "mixins/ajax.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function(b, a) {
        var c = a.merge,
            g = a.objectEach;
        b.ajax = function(b) {
            var a = c(!0, {
    ...
    e(c, "mixins/download-url.js", [c["parts/Globals.js"]], function(b) {
        ...
        b.dataURLtoBlob = function(b) {
            if ((b = b.match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < b.length && a.atob && a.ArrayBuffer && a.Uint8Array && a.Blob && e.createObjectURL) {
                var d = a.atob(b[3]),
        ...
        b.downloadURL = function(d, e) {
            ...
            if ("string" === typeof d || d instanceof String || !c.msSaveOrOpenBlob) {
                ...
                if ("undefined" !== typeof f.download) f.href = d, f.download = e, g.body.appendChild(f), f.click(), g.body.removeChild(f);
                else try {
                    var l = a.open(d, "chart");
                    if ("undefined" === typeof l || null === l) throw Error("Failed to open window");
                } catch (y) {
                    a.location.href = d
                }
    ...
    e(c, "modules/export-data.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function(b, a) {
        function c(a, b) {
            var c = d.navigator,
                n = -1 < c.userAgent.indexOf("WebKit") && 0 > c.userAgent.indexOf("Chrome"),
            ...
            try {
                ...
                if (!n) return f.createObjectURL(new d.Blob(["\ufeff" + a], {
                    type: b
                }))
            } catch (H) {}
        }
        ...
        b.Chart.prototype.getDataRows = function(a) {
            ...
            var w = u.categoryHeader,
                ...
                E = function(k, c, d) {
                    ...
                    return k ? k instanceof b.Axis ? k.options.title && k.options.title.text || (k.dateTime ? m : w) : a ? {
            ...
            this.series.forEach(function(k) {
                var m = k.xAxis,
                    ...
                    z = F(k, e),
                    g;
                if (!1 !== k.options.includeInDataExport && !k.options.isInternal &&
                    !1 !== k.visible) {
                    b.find(h, function(a) {
                        return a[0] === w
                    }) || h.push([w, v]);
                    for (g = 0; g < l;) r = E(k, e[g], e.length), A.push(r.columnTitle || r), a && D.push(r.topLevelColumnTitle || r), g++;
                    var u = {
                        chart: k.chart,
                    ...
                    k.options.data.forEach(function(a, b) {
                        ...
                        g = 0;
                        if (!m || "name" === k.exportKey || !c && m && m.hasNames) a = n;
                        p && (p[a] && (a += "|" + b),
                            p[a] = !0);
                        q[a] || (q[a] = [], q[a].xValues = []);
                        q[a].x = h.x;
                        q[a].name = n;
                        for (q[a].xValues[w] = h.x; g < l;) b = e[g], n = h[b], q[a][v + g] = t(z.categoryMap[b][n], z.dateTimeValueAxisMap[b] ? d.dateFormat(f.dateFormat, n) : null, n), g++
                    });
                    v += g
                }
            });
            ...
            for (v = h.length; v--;) {
                ...
                l.forEach(function(a) {
                    var b = a.name;
                    x && !e(b) &&
                        (x.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), b = d.dateFormat(f.dateFormat, a.x)) : b = x.categories ? t(x.names[a.x], x.categories[a.x], a.x) : a.x);
                    a.splice(g, 0, b)
                })
            }
            p = p.concat(l);
        ...
        b.Chart.prototype.getCSV = function(a) {
            var b = "",
                ...
                n = t(d.decimalPoint, "," !== d.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."),
                f = t(d.itemDelimiter, "," === n ? ";" : ","),
                e = d.lineDelimiter;
            c.forEach(function(a, d) {
                for (var g, l = a.length; l--;) g = a[l],
                    "string" === typeof g && (g = '"' + g + '"'), "number" === typeof g && "." !== n && (g = g.toString().replace(".", n)), a[l] = g;
                b += a.join(f);
                d < c.length - 1 && (b += e)
            });
            return b
        ...
        b.Chart.prototype.getTable = function(a) {
            ...
            var f = 0,
                ...
                n = function(a, b, c, g) {
                    var h = t(g, "");
                    b = "text" + (b ? " " + b : "");
                    "number" === typeof h ? (h = h.toString(), "," === d && (h =
                        h.replace(".", d)), b = "number") : g || (b = "empty");
                    return "<" + a + (c ? " " + c : "") + ' class="' + b + '">' + h + "</" + a + ">"
                };
            !1 !== c.exporting.tableCaption && (b += '<caption class="highcharts-table-caption">' + t(c.exporting.tableCaption, c.title.text ? c.title.text.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;") : "Chart") + "</caption>");
            ...
            b += function(a, b, d) {
                ...
                if (e) {
                    for (f += "<tr>"; h < d; ++h) {
                        e = a[h];
                        var m = a[h + 1];
                        e === m ? ++l : l ? (f += n("th", "highcharts-table-topheading", 'scope="col" colspan="' + (l + 1) + '"', e), l = 0) : (e === b[h] ? c.exporting.useRowspanHeaders ? (m = 2, delete b[h]) : (m = 1, b[h] = "") : m = 1, f += n("th", "highcharts-table-topheading", 'scope="col"' + (1 < m ? ' valign="top" rowspan="' + m + '"' : ""), e))
                    }
                    f += "</tr>"
                }
                if (b) {
                    f += "<tr>";
                    h = 0;
                    for (d = b.length; h < d; ++h) "undefined" !==
                        typeof b[h] && (f += n("th", null, 'scope="col"', b[h]));
                    f += "</tr>"
                }
                return f + "</thead>"
        ...
        b.Chart.prototype.downloadCSV = function() {
            var a = this.getCSV(!0);
            l(c(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a), this.getFilename() + ".csv")
        };
        b.Chart.prototype.downloadXLS = function() {
            ...
            l(c(a, "application/vnd.ms-excel") || "data:application/vnd.ms-excel;base64," + d.btoa(unescape(encodeURIComponent(a))), this.getFilename() + ".xls")
        };
        b.Chart.prototype.viewData = function() {
            this.dataTableDiv || (this.dataTableDiv = C.createElement("div"), this.dataTableDiv.className = "highcharts-data-table", this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
            this.dataTableDiv.innerHTML = this.getTable();
            y(this, "afterViewData", this.dataTableDiv)
        };
        if (a =
            b.getOptions().exporting) G(a.menuItemDefinitions, {
            downloadCSV: {
                textKey: "downloadCSV",
                onclick: function() {
                    this.downloadCSV()
        ...
        f.treemap && (f.treemap.prototype.exportKey =
            "name")
    });
