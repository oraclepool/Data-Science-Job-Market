...
(function(factory) {
    ...
    function Category(obj, parent) {
        ...
        this.name = obj ? (obj.name || obj) : null;
        this.parent = parent;
    ...
    tickProto.render = function(index, old, opacity) {
        ...
        if (isFirst) {
            gridAttrs = horiz ? [axis.left, xy.y, axis.left, xy.y + axis.groupSize(true)] : axis.isXAxis ? [xy.x, axis.top, xy.x + axis.groupSize(true), axis.top] : [xy.x, axis.top + axis.len, xy.x + axis.groupSize(true), axis.top + axis.len];
