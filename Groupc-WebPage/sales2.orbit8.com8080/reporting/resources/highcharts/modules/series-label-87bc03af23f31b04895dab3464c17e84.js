...
*/
(function(m) {
    "object" === typeof module && module.exports ? (m["default"] = m, module.exports = m) : "function" === typeof define && define.amd ? define("highcharts/modules/series-label", ["highcharts"], function(w) {
        m(w);
        m.Highcharts = w;
        return m
    ...
    function w(m, u, y, z) {
        m.hasOwnProperty(u) || (m[u] = z.apply(null, y))
    }
    m = m ? m._modules : {};
    w(m, "modules/series-label.src.js", [m["parts/Globals.js"], m["parts/Utilities.js"]], function(m, u) {
        function y(e, d, a, l, f, g) {
            e = (g - d) *
                (a - e) - (l - d) * (f - e);
            return 0 < e ? !0 : !(0 > e)
        }
        ...
        function z(e, d, a, l, f, g, b, k) {
            return y(e, d, f, g, b, k) !== y(a, l, f, g, b, k) && y(e, d, a, l, f, g) !== y(e, d, a, l, b, k)
        }

        function w(e, d, a, l, f, g, b, k) {
            return z(e, d, e + a, d, f, g, b, k) || z(e + a, d, e + a, d + l, f, g, b, k) || z(e, d + l, e + a, d + l, f, g, b, k) || z(e, d, e, d + l, f, g, b, k)
        }

        function F(e) {
            if (this.renderer) {
                var d = this,
                    a = B(d.renderer.globalAnimation).duration;
                d.labelSeries = [];
                ...
                d.series.forEach(function(l) {
                    ...
                    f.enabled && l.visible && (l.graph || l.area) && !l.isSeriesBoosting && (d.labelSeries.push(l), f.minFontSize && f.maxFontSize && (l.sum = l.yData.reduce(function(a, b) {
                        return (a || 0) + (b || 0)
                    }, 0), d.labelSeriesMaxSum = Math.max(d.labelSeriesMaxSum, l.sum)), "load" === e.type && (a = Math.max(a, B(l.options.animation).duration)), b && ("undefined" !== typeof b[0].plotX ? g.animate({
                        x: b[0].plotX + b[1],
                        y: b[0].plotY + b[2]
                    }) : g.attr({
                        opacity: 0
        ...
        L.prototype.symbols.connector = function(e, d, a, l, f) {
            var g = f && f.anchorX;
            f = f && f.anchorY;
            var b = a / 2;
            if (C(g) && C(f)) {
        ...
        D.prototype.labelFontSize = function(e, d) {
            return e + this.sum / this.chart.labelSeriesMaxSum * (d - e) + "px"
        };
        D.prototype.checkClearPoint =
            function(e, d, a, l) {
                ...
                for (x = 0; x < m.series.length; x += 1)
                    if (v = m.series[x], n = v.interpolatedPoints, v.visible && n) {
                        for (c = 1; c < n.length; c += 1) {
                            if (n[c].chartX >= e - 16 && n[c - 1].chartX <= e + a.width + 16) {
                                if (w(e, d, a.width, a.height,
                                        n[c - 1].chartX, n[c - 1].chartY, n[c].chartX, n[c].chartY)) return !1;
                                this === v && !b && l && (b = w(e - 16, d - 16, a.width + 32, a.height + 32, n[c - 1].chartX, n[c - 1].chartY, n[c].chartX, n[c].chartY))
                            }
                            if ((h || b) && (this !== v || k)) {
                        ...
                        if (!k && h && this === v && (l && !b || f < Math.pow(this.options.label.connectorNeighbourDistance, 2))) {
                            for (c = 1; c < n.length; c += 1)
                                if (b = Math.min(Math.pow(e + a.width / 2 - n[c].chartX, 2) + Math.pow(d + a.height / 2 - n[c].chartY, 2), Math.pow(e - n[c].chartX,
                                        2) + Math.pow(d - n[c].chartY, 2), Math.pow(e + a.width - n[c].chartX, 2) + Math.pow(d - n[c].chartY, 2), Math.pow(e + a.width - n[c].chartX, 2) + Math.pow(d + a.height - n[c].chartY, 2), Math.pow(e - n[c].chartX, 2) + Math.pow(d + a.height - n[c].chartY, 2)), b < g) {
                                    g = b;
                                    var p = n[c]
                                }
                            b = !0
        ...
        E.prototype.drawSeriesLabels = function() {
            ...
            e.series.forEach(function(a) {
                ...
                if (f && (a.xAxis || a.yAxis)) {
                    ...
                    var p = f.minFontSize;
                    var r = f.maxFontSize;
                    var t = "highcharts-color-" + A(a.colorIndex,
                        "none");
                    if (v && !k) {
                    ...
                    if (a.visible && !a.isSeriesBoosting && c) {
                        ...
                        for (k = c.length - 1; 0 < k; --k) v ? (r = c[k].chartX - p.width / 2, t = c[k].chartCenterY - p.height / 2, d(r, t, p) && (b = a.checkClearPoint(r, t, p))) : (r = c[k].chartX + 3, t = c[k].chartY - p.height - 3, d(r, t, p) && (b = a.checkClearPoint(r, t, p, !0)), b && g.push(b), r = c[k].chartX + 3, t = c[k].chartY + 3, d(r, t, p) && (b = a.checkClearPoint(r,
                            t, p, !0)), b && g.push(b), r = c[k].chartX - p.width - 3, t = c[k].chartY + 3, d(r, t, p) && (b = a.checkClearPoint(r, t, p, !0)), b && g.push(b), r = c[k].chartX - p.width - 3, t = c[k].chartY - p.height - 3, d(r, t, p) && (b = a.checkClearPoint(r, t, p, !0))), b && g.push(b);
                        ...
                        if (g.length) {
                            if (g.sort(function(a, b) {
                                ...
                                (c = Math.sqrt(Math.pow(Math.abs(b.x - q.x), 2), Math.pow(Math.abs(b.y - q.y), 2))) && a.labelBySeries && (g = {
                                    opacity: e.renderer.forExport ? 1 : 0,
                                    x: b.x,
                                    y: b.y
                                }, f = {
                                    ...
                                    x: g.x,
                                    y: g.y
                                }, g = {}), c = void 0, w && (c = B(a.options.animation), c.duration *= .2), a.labelBySeries.attr(H(g, {
                                    ...
                                    chartX: b.x,
                                    chartY: b.y
                                }, !0))) q.closest = [a, b.x - (a.plotX || 0), b.y - (a.plotY ||
                                0)]
