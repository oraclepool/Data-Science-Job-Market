...
*/
(function(g) {
    "object" === typeof module && module.exports ? (g["default"] = g, module.exports = g) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function(n) {
        g(n);
        g.Highcharts = n;
        return g
    ...
    function n(e, f, g, l) {
        e.hasOwnProperty(f) || (e[f] = l.apply(null, g))
    }
    g = g ? g._modules : {};
    n(g, "modules/full-screen.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"]], function(e, f) {
        var g = f.addEvent;
        f = e.Chart;
        var l = function() {
            function e(k) {
                ...
                this.isOpen = !1;
                k = k.renderTo;
                this.browserProps || ("function" === typeof k.requestFullscreen ? this.browserProps = {
                    fullscreenChange: "fullscreenchange",
                    requestFullscreen: "requestFullscreen",
                    exitFullscreen: "exitFullscreen"
                } : k.mozRequestFullScreen ? this.browserProps = {
                    fullscreenChange: "mozfullscreenchange",
                    requestFullscreen: "mozRequestFullScreen",
                    exitFullscreen: "mozCancelFullScreen"
                } : k.webkitRequestFullScreen ? this.browserProps = {
                    fullscreenChange: "webkitfullscreenchange",
                    requestFullscreen: "webkitRequestFullScreen",
                    exitFullscreen: "webkitExitFullscreen"
                } : k.msRequestFullscreen && (this.browserProps = {
            ...
            e.prototype.close = function() {
                var k = this.chart;
                if (this.isOpen && this.browserProps && k.container.ownerDocument instanceof Document) k.container.ownerDocument[this.browserProps.exitFullscreen]();
            ...
            e.prototype.open = function() {
                var k =
                    ...
                    e = k.chart;
                if (k.browserProps) {
                    k.unbindFullscreenEvent = g(e.container.ownerDocument, k.browserProps.fullscreenChange, function() {
                        k.isOpen ? (k.isOpen = !1, k.close()) : (k.isOpen = !0, k.setButtonText())
                    });
                    var f = e.renderTo[k.browserProps.requestFullscreen]();
                    if (f) f["catch"](function() {
                        alert("Full screen is not supported inside a frame.")
                    });
                    g(e, "destroy", k.unbindFullscreenEvent)
                }
            };
            e.prototype.setButtonText = function() {
                var e, f = this.chart,
                    g = f.exportDivElements,
                    l = f.options.exporting,
                    q = null === (e = null === l || void 0 ===
                        l ? void 0 : l.buttons) || void 0 === e ? void 0 : e.contextButton.menuItems;
                e = f.options.lang;
                (null === l || void 0 === l ? 0 : l.menuItemDefinitions) && (null === e || void 0 === e ? 0 : e.exitFullscreen) && e.viewFullscreen && q && g && g.length && (g[q.indexOf("viewFullscreen")].innerHTML = this.isOpen ? e.exitFullscreen : l.menuItemDefinitions.viewFullscreen.text || e.viewFullscreen)
            };
        ...
        e.Fullscreen = l;
        g(f, "beforeRender", function() {
            this.fullscreen = new e.Fullscreen(this)
        });
        return e.Fullscreen
    });
    n(g, "mixins/navigation.js", [], function() {
        return {
                ...
                e.navigation || (e.navigation = {
                    ...
                    update: function(e, g) {
                        this.updates.forEach(function(f) {
                            f.update.call(f.context, e, g)
                        })
                    }
                })
            },
            addUpdate: function(e, f) {
    ...
    n(g, "modules/exporting.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"], g["mixins/navigation.js"]], function(e, f, g) {
        var l = f.addEvent,
            q = f.css,
            k = f.createElement,
            n = f.discardElement,
            ...
            F = e.SVGRenderer,
            H = e.Renderer.prototype.symbols,
        ...
        e.isSafari && e.win.matchMedia("print").addListener(function(a) {
            e.printingChart && (a.matches ? e.printingChart.beforePrint() : e.printingChart.afterPrint())
        });
        w(B.prototype, {
            ...
            getSVG: function(a) {
                var b, c = r(this.options, a);
                c.plotOptions = r(this.userOptions.plotOptions, a && a.plotOptions);
                c.time = r(this.userOptions.time, a && a.time);
                var d = k("div",
                    null, {
                        position: "absolute",
                        top: "-9999em",
                ...
                var u = new e.Chart(c, this.callback);
                a && ["xAxis", "yAxis", "series"].forEach(function(b) {
                    var d = {};
                    a[b] && (d[b] = a[b], u.update(d))
                });
                this.axes.forEach(function(a) {
                    var b = I(u.axes, function(b) {
            ...
            contextMenu: function(a, b, c, d, e, g, u) {
                var h = this,
                    D = h.options.navigation,
                    r = h.chartWidth,
                    z = h.chartHeight,
                    p = "cache-" + a,
                    m = h[p],
                    C = Math.max(e, g);
                if (!m) {
                    h.exportContextMenu = h[p] = m = k("div", {
                        className: a
                    }, {
                        position: "absolute",
                        zIndex: 1E3,
                    ...
                    m.hideMenu = function() {
                        ...
                        A(h, "exportMenuHidden")
                    };
                    h.exportEvents.push(l(m, "mouseleave", function() {
                            m.hideTimer = y.setTimeout(m.hideMenu, 500)
                        }), l(m, "mouseenter", function() {
                            f.clearTimeout(m.hideTimer)
                        }),
                        l(x, "mouseup", function(b) {
                    ...
                    b.forEach(function(a) {
                        ...
                        if (J(a, !0)) {
                            if (a.separator) var b = k("hr", null, null, n);
                            else b = k("li", {
                            ...
                            }, null, n), h.styledMode || (b.onmouseover = function() {
                                q(this,
                                    D.menuItemHoverStyle)
                            }, b.onmouseout = function() {
                                q(this, D.menuItemStyle)
                            }, q(b, w({
                                cursor: "pointer"
                            }, D.menuItemStyle)));
                ...
                c + h.exportMenuWidth > r ? b.right = r - c - e - C + "px" : b.left = c - C + "px";
                d + g + h.exportMenuHeight > z && "top" !== u.alignOptions.verticalAlign ? b.bottom = z - d - C + "px" : b.top = d + g - C + "px";
                q(m, b);
                q(h.renderTo, {
                    overflow: ""
                });
            ...
            addButton: function(a) {
                var b =
                    this,
                    c = b.renderer,
                    d = r(b.options.navigation.buttonOptions, a),
                    e = d.onclick,
                    f = d.menuItems,
                    g = d.symbolSize || 12;
                ...
                if (!1 !== d.enabled) {
                    ...
                    e ? z = function(a) {
                        ...
                        b.contextMenu(p.menuClassName, f, p.translateX,
                            p.translateY, p.width, p.height, p);
                        p.setState(2)
                    });
                    d.text && d.symbol ? h.paddingLeft = t(h.paddingLeft, 25) : d.text || w(h, {
                        width: d.width,
                        height: d.height,
                        padding: 0
                    });
                    b.styledMode || (h["stroke-linecap"] = "round", h.fill = t(h.fill, "#ffffff"), h.stroke = t(h.stroke, "none"));
                    var p = c.button(d.text, 0, 0, z, h, l, k).addClass(a.className).attr({
                        title: t(b.options.lang[d._titleKey || d.titleKey], "")
                    });
                    p.menuClassName = a.menuClassName || "highcharts-menu-" + b.btnCount++;
                    if (d.symbol) {
                    ...
                    p.add(b.exportingGroup).align(w(d, {
                        width: p.width,
                        x: t(d.x, b.buttonOffset)
                    }), !0, "spacingBox");
                    b.buttonOffset += (p.width + d.buttonSpacing) * ("right" === d.align ? -1 : 1);
                    b.exportSVGElements.push(p, m)
                }
            },
        ...
        B.prototype.inlineStyles = function() {
            ...
            function b(c) {
                function p(b, f) {
                    n = q = !1;
                    if (g) {
                        for (t = g.length; t-- && !q;) q = g[t].test(f);
                        n = !q
                    }
                    "transform" === f && "none" === b && (n = !0);
                    for (t = e.length; t-- && !n;) n = e[t].test(f) ||
                        "function" === typeof b;
                    n || w[f] === b && "svg" !== c.nodeName || h[c.nodeName][f] === b || (-1 !== d.indexOf(f) ? c.setAttribute(a(f), b) : m += a(f) + ":" + b + ";")
                }
                var m = "",
                    n, q, t;
                if (1 === c.nodeType && -1 === f.indexOf(c.nodeName)) {
                    var u = y.getComputedStyle(c, null);
                    ...
                    if (!h[c.nodeName]) {
                        ...
                        k.appendChild(v);
                        h[c.nodeName] = r(y.getComputedStyle(v, null));
                        "text" === c.nodeName && delete h.text.fill;
                        k.removeChild(v)
                    }
                    if (O || N)
                        for (var x in u) p(u[x], x);
                    else E(u, p);
                    m && (u = c.getAttribute("style"), c.setAttribute("style", (u ? u + ";" : "") + m));
        ...
        l(B, "init", function() {
            ...
            a.exporting = {
                update: function(b, c) {
                    ...
                    r(!0, a.options.exporting, b);
                    t(c, !0) && a.redraw()
                }
            };
            g.addUpdate(function(b, c) {
                a.isDirtyExporting = !0;
                r(!0, a.options.navigation,
                    b);
                t(c, !0) && a.redraw()
            }, a)
        });
