...
*/
(function(b) {
    "object" === typeof module && module.exports ? (b["default"] = b, module.exports = b) : "function" === typeof define && define.amd ? define("highcharts/modules/solid-gauge", ["highcharts", "highcharts/highcharts-more"], function(h) {
        b(h);
        b.Highcharts = h;
        return b
    ...
    b = b ? b._modules : {};
    h(b, "modules/solid-gauge.src.js", [b["parts/Globals.js"], b["parts/Color.js"], b["mixins/legend-symbol.js"],
        b["parts/Utilities.js"]
    ], function(b, h, x, g) {
        var k = h.parse,
            r = g.clamp,
            u = g.extend,
        ...
        var z = {
            initDataClasses: function(a) {
                var d = this.chart,
                    ...
                    m = this.options;
                this.dataClasses = b = [];
                a.dataClasses.forEach(function(c,
                    f) {
                    c = y(c);
                    b.push(c);
            ...
            toColor: function(a, b) {
                ...
                if (e)
                    for (d = e.length; d--;) {
                        ...
                        var g = c.from;
                        f = c.to;
                        if (("undefined" === typeof g || a >= g) && ("undefined" ===
                                typeof f || a <= f)) {
                            var h = c.color;
                            b && (b.dataClass = d);
                            break
            ...
            drawPoints: function() {
                ...
                a.points.forEach(function(c) {
                    if (!c.isNull) {
                        ...
                        a.chart.styledMode || ("square" !== e.linecap &&
                            d.attr({
